...
export class Model {
  ...
  static from_dict(model_dict: {
    ...
    if (
      typeof model_dict.model_name !== "string" ||
      !model_dict.model_name.trim()
    ) {
      throw new Error(
    ...
    if (
      !model_dict.model_header ||
      typeof model_dict.model_header !== "object"
    ) {
      throw new Error(
    ...
    for (const [k, v] of Object.entries(
      model_dict.model_header as Record<string, unknown>,
    )) {
